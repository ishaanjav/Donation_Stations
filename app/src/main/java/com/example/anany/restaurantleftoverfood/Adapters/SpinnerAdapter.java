...
public class SpinnerAdapter extends ArrayAdapter<String> {
    ...
    public SpinnerAdapter(@NonNull Context context, int resource, @NonNull List<String> objects, Resources resLocal) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        View row = mInflater.inflate(R.layout.forgot_spinner, parent, false);
