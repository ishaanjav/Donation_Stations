...
public class DonationsList {
    ...
    public String message, messageInfo;
    ...
    String shelterStatus, shelterAmount;
    ...
    public DonationsList(String name, String managerName, String contactPhone, String address, String website,
                         String openingHours, String distance, String units, boolean same, double lat, double lon, double toLat, double toLon,
                         String shelterVC, String restaurantVC, String cAddress, String cName, String cPhone,
                         String cWebsite, String cManager, String cHours, String cStatus, String date, String time, String message, String messageInfo,
                         String ss, String sa, String requestDate, String requestTime) {
        this.name = name;
