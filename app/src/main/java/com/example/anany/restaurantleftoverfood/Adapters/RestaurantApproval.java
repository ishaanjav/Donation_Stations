...
public class RestaurantApproval extends ArrayAdapter<DonationsList> {
    private Context mContext;
    private List<DonationsList> list = new ArrayList<>();
    Button request, moreInfo;
    ImageView call, copy;

    public RestaurantApproval(@NonNull Context context, ArrayList<DonationsList> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        listItem = LayoutInflater.from(mContext).inflate(R.layout.restaurant_needs_accept, parent, false);
        clicks = 0;
        clicks2 = 0;
        ...
        date.setText(row.getRequestTime() + ", " + row.getRequestDate());
        ...
        status.setText(row.getShelterStatus());

        TextView amount = listItem.findViewById(R.id.amount);
        amount.setText(row.getShelterAmount());
    ...
    private void processRestaurantApproval(final View listItem, final DonationsList row) {
        Button approve = listItem.findViewById(R.id.approve);
        Button decline = listItem.findViewById(R.id.decline);
        Button moreInfo = (Button) listItem.findViewById(R.id.moreInfo);
                        ...
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            ...
                            dbref.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            dbref.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                    for (DataSnapshot child : dataSnapshot.getChildren()) {
                                                        ...
                                                        //makeToast(status + " " + row.getStatus());
                                                        // makeToast(status + " " + row.getStatus() + "\n" + (status.equals(row.getStatus())));
                                                        if (tempVC.equals(row.getRestaurantVC()) && status.equals(row.getStatus())) {
                                                            ...
                                                            dbref.child(child.getKey()).child("Status").setValue("Pickup")/*.addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                @Override
                                                            ...
                                                            /*.addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                    ...
                                                                    Rdbref.addValueEventListener(new ValueEventListener() {
                                                                        @Override
                                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                            for (DataSnapshot child : dataSnapshot.getChildren()) {
                                                                                ...
                                                                                if (VC2.equals(row.getRestaurantVC())) {
                                                                                    ...
                                                                                    Rdbref2.addValueEventListener(new ValueEventListener() {
                                                                                        @Override
                                                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                            for (DataSnapshot child : dataSnapshot.getChildren()) {
                                                                                                String status = child.child("Status").getValue().toString();
                                                                                                ...
                                                                                                if (tempVC.equals(row.getShelterVC())) {
                                                                                                    ...
                                                                                                    vals.put("Cancel Date", quicker(child, "Cancel Date"));
                                                                                                    vals.put("Cancel Time", quicker(child, "Cancel Time"));
                                                                                                    ...
                                                                                                    final Snackbar snackbar = Snackbar
                                                                                                            .make(listItem, "Thank you for offering a donation to " + row.getName()+ "!", Snackbar.LENGTH_INDEFINITE)
                                                                                                            .setDuration(2100);
                                ...
                                Rdbref.addValueEventListener(new ValueEventListener() {
                                                            ...
                                                            final DatabaseReference Rdbref2 = FirebaseDatabase.getInstance().getReference("Accept/" + row.getRestaurantVC());
                                                            Rdbref2.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                ...
                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                    for (DataSnapshot child : dataSnapshot.getChildren()) {
                                                                        String status = child.child("Status").getValue().toString();
                                                                        String tempVC = child.child("Shelter VC").getValue().toString();
                                                                        makeToast(tempVC + " " + row.getShelterVC());
                                                                        ...
                                                                        if (tempVC.equals(row.getShelterVC())) {
                                                                            ...
                                                                            DonationsRestaurant.readPendingOffers();
...
//                            });
        ...
        moreInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                show.setContentView(R.layout.request_shelter_info);
                show.setCancelable(true);
